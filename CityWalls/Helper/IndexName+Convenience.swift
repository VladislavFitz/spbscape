...
extension ApplicationID {
  static let cityWallsAppID: ApplicationID = CityWallsCredentials.credentials.appID
}

extension APIKey {
  static let cityWallsApiKey: APIKey = CityWallsCredentials.credentials.APIKey
}
